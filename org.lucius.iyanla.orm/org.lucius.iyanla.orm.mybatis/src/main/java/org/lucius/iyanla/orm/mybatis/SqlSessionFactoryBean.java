 ...
 */
package org.lucius.iyanla.orm.mybatis;
...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean,
		ApplicationListener<ApplicationEvent>, BundleContextAware, BundleListener {
		...
		while (tokenizer.hasMoreElements()) {
			...
			if (!entryPattern.startsWith("*")) {
				throw new IllegalArgumentException(
						String.format("Illegal mapper locations definition. Bad match pattern: %s", pattern));
			}
	...
	private void scanMappers(Bundle bundle, String location, String entryPattern, boolean recurse,
